<x-admin-layout>
    <div class="overflow-x-auto p-6 bg-gray-100">
        ...
        <div class="rounded-lg bg-white p-6 shadow-md">
            ...
            <form action="{{ route('kegiatan.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                @method('PUT')
                <div class="mb-4">
                    ...
                    <div id="drop-area"
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <img id="preview" src="{{ asset('assets/images/kegiatan/' . $kegiatan->gambar)}}" alt="Image" class="mt-2 w-48 h-48 object-cover rounded-md shadow-md" style="{{ $kegiatan->gambar ? '' : 'display: none;' }}">
                        </div>
                    </div>
                    @error('gambar')
