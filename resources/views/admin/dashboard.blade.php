            ...
            <div class="mt-8">
                <div class="flex flex-wrap -mx-6">
                    <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                        <div class="flex items-center px-5 py-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm card-hover transition duration-300">
                            ...
                            <div class="mx-5">
                                <h4 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ $totalSiswa }}</h4>
                    ...
                    <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                        <div class="flex items-center px-5 py-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm card-hover transition duration-300">
                            ...
                            <div class="mx-5">
                                <h4 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ $totalGaleri }}</h4>
                                <div class="text-gray-500 dark:text-gray-400">Total Galeri</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                        <div class="flex items-center px-5 py-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm card-hover transition duration-300">
                            ...
                            <div class="mx-5">
                                <h4 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">{{ $totalKegiatan }}</h4>
                                <div class="text-gray-500 dark:text-gray-400">Total Kegiatan</div>
                            </div>
                        </div>
                    </div>
                </div>
