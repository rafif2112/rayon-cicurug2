        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 dark:text-gray-400 sm:text-center"><a href="#">© 2024 </a><a
                        href="https://muhamadrafif.vercel.app/"
                        class="font-semibold text-blue-600 hover:underline">Muhamad Rafif</a>. All Rights Reserved.
                </span>
                <div class="mt-4 flex sm:mt-0 sm:justify-center">
                    <a href="https://instagram.com/rafiff.21"
                        class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg class="-mt-[1px] h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="https://wa.me/6281283330396"
                    ...
                    <a href="https://linkedin.com/in/muhamad-rafif22"
                        class="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg class="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="https://github.com/rafif2112"
                        class="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg class="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
