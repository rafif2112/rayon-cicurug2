    <nav class="fixed top-0 h-20 w-full border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-900" style="z-index: 50">
        <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between px-4 py-5">
            ...
            <button data-collapse-toggle="navbar-dropdown" type="button" 
                class="inline-flex h-12 w-12 items-center justify-center rounded-lg p-2 
                text-gray-600 transition-all duration-200
                hover:bg-blue-50 hover:text-blue-600
                focus:outline-none focus:ring-2 focus:ring-blue-200
                dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-600 
                md:hidden"
                aria-controls="navbar-dropdown" 
                aria-expanded="false">
                <span class="sr-only">Toggle navigation menu</span>
                <svg class="h-6 w-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
